...
export const DisasterDetailsVol: React.FC = () => {
    ...
    const tabs = [
        { name: 'Volunteer Overview', icon: EyeIcon, description: 'Current situation and details' },
        { name: 'Community Resources', icon: TruckIcon, description: 'Available resources' },
        { name: 'Volunteer Actions', icon: ShieldCheckIcon, description: 'Ways to help' },
    ];
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
            ...
            <div className={`relative ${emergencyType.bgColor} ${emergencyType.borderColor} border-b transition-colors duration-300`}>
                ...
                {/* Animated Elements */}
                <div className="absolute top-4 right-4 w-3 h-3 bg-green-400/30 rounded-full animate-ping"></div>
                            ...
                            <div className="bg-gradient-to-r from-green-600 to-green-700 dark:from-green-700 dark:to-green-800 px-6 py-4">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <span className="text-sm font-medium text-green-100">COMMUNITY RESPONSE</span>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    {tabs.map((tab, index) => (
                                        <button
                                            ...
                                            className={`group flex items-center space-x-3 px-6 py-4 text-sm font-medium border-b-3 transition-all duration-300 hover:bg-white dark:hover:bg-gray-800 ${selectedTab === index
                                                    ? 'border-green-500 text-green-600 dark:text-green-400 bg-white dark:bg-gray-800 shadow-sm'
                                                        ...
                                                        <>
                                                            <DisclosureButton className="flex w-full justify-between rounded-xl bg-blue-100 dark:bg-blue-800/50 px-6 py-4 text-left font-medium text-blue-900 dark:text-blue-100 hover:bg-blue-200 dark:hover:bg-blue-800 focus:outline-none focus-visible:ring focus-visible:ring-blue-500 focus-visible:ring-opacity-75 transition-all duration-300">
                                                                <span className="flex items-center">
                                                                    <UserIcon className="w-5 h-5 mr-2" />
                                                                    View Community Safety Guidelines
                                                                </span>
                                                                <ChevronDownIcon
                                    ...
                                    <div className="space-y-8">
                                        <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-xl p-6">
                                            ...
                                            <div className="text-sm text-yellow-700 dark:text-yellow-300 mb-4">
                                                Available community resources and volunteer coordination points
                                            </div>
                                        </div>
                                        <ResourceMap
                                    ...
                                    <div className="space-y-8">
                                        <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-xl p-6">
                                            ...
                                            <div className="text-sm text-green-700 dark:text-green-300 mb-4">
                                                Ways you can help and contribute to the emergency response
                                            </div>
                                        </div>
